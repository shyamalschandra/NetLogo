  ...
  override def makeWidget(coreWidget: CoreWidget): Widget = {
    ...
    if (fromRegistry != null)
      ...
      case i: CoreInputBox =>
        ...
        val textArea = new CodeEditor(1, 20, font, true, null, new EditorColorizer(workspace))
        val dialogTextArea = new CodeEditor(5, 20, font, false, null, new EditorColorizer(workspace))
